---
title: "DataNormalization_CyanoAq_June2017"
author: "Laura Hmelo"
...
Experiment <- "CyanoAq_June2017Data"
...
#load BMIS normalized CyanoAq xset data
...
#Normalize CyanoAq data to cell and vesicle counts
```{r norm to vesicles, message=FALSE, warning=FALSE, include=FALSE}
...
#Normalize CyanoAq data to biovolume
```{r norm to vesicles, message=FALSE, warning=FALSE, include=FALSE}
 names <- unique(data$Replicate.Name)
Samples <-as.character(names[grepl("Smp", names)])
  # Blk2 <- names[grepl("Blk_2", names)]
