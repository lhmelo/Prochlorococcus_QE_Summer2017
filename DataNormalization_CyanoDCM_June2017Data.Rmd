---
title: "DataNormalization_CyanoDCM_June2017"
author: "Laura Hmelo"
...
#load BMIS normalized CyanoDCM xset data
...
#Normalize CyanoDCM data to cell and vesicle counts
```{r norm to vesicles, message=FALSE, warning=FALSE, include=FALSE}
...
#Normalize CyanoDCM data to biovolume
```{r norm to vesicles, message=FALSE, warning=FALSE, include=FALSE}
 names <- unique(data$Replicate.Name)
Samples <-as.character(names[grepl("Smp", names)])
  # Blk2 <- names[grepl("Blk_2", names)]
